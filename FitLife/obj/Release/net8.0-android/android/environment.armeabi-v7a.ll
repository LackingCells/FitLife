...
@dso_cache = dso_local local_unnamed_addr global [580 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 259487786, ; hash 0xf77782a, from name: Syncfusion.Maui.Charts
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1018299499, ; hash 0x3cb2046b, from name: aot-FitLife
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1445631218, ; hash 0x562a94f2, from name: FitLife
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitLife.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	...
	%struct.DSOCacheEntry {
		i64 1463486801, ; hash 0x573b0951, from name: aot-Syncfusion.Maui.Charts
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Charts.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 1822954135, ; hash 0x6ca81297, from name: libaot-Syncfusion.Maui.Charts.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Charts.dll.so
		ptr null; void* handle (0x0)
	}, ; 227
	...
	%struct.DSOCacheEntry {
		i64 1899573039, ; hash 0x71392f2f, from name: aot-Syncfusion.Maui.Charts.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Charts.dll.so
		ptr null; void* handle (0x0)
	}, ; 235
	...
	%struct.DSOCacheEntry {
		i64 2211170223, ; hash 0x83cbc7af, from name: FitLife.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitLife.dll.so
		ptr null; void* handle (0x0)
	}, ; 288
	...
	%struct.DSOCacheEntry {
		i64 2664972515, ; hash 0x9ed840e3, from name: libaot-FitLife
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitLife.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 3220677058, ; hash 0xbff7a1c2, from name: aot-FitLife.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitLife.dll.so
		ptr null; void* handle (0x0)
	}, ; 441
	...
	%struct.DSOCacheEntry {
		i64 3251586741, ; hash 0xc1cf46b5, from name: Syncfusion.Maui.Charts.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Charts.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
	...
	%struct.DSOCacheEntry {
		i64 3759244604, ; hash 0xe011853c, from name: libaot-FitLife.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitLife.dll.so
		ptr null; void* handle (0x0)
	}, ; 508
	...
	%struct.DSOCacheEntry {
		i64 3910040125, ; hash 0xe90e7a3d, from name: libaot-Syncfusion.Maui.Charts
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Charts.dll.so
		ptr null; void* handle (0x0)
	}, ; 527
